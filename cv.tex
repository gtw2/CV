...
%    \end{graytext}
    ...
    \item \textbf{Westphal, G.} ``Full-core analysis of thorium-fueled Molten Salt Breeder Reactor using the SERPENT 2 Monte Carlo code'' 
            \textbf{University Program Review.} 
            Ann Arbor, MI, June 2018.
    \item \textbf{Westphal, G.}, Huff, K. ``Signatures and Observables of the Nuclear Fuel Cycle'', \textbf{Consortia for Non-proliferation Enabling Capabilities Review}, 
